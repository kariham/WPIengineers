const questionsData = {
    ...
    seveso: {
        ...
        questions: [
            ...
            "Zijn de opvangbakken (retentiebakken) leeg, schoon en hebben ze voldoende capaciteit?",
    ...
    questionsData[type].questions.forEach((q, index) => {
        container.innerHTML += `
            <div class="question-block">
                ...
                <input type="text" id="comment_${index}" placeholder="Opmerkingen / Actiehouder">
            </div>
        `;
    });
}
...
// Deze check voorkomt de addEventListener-fout als het formulier nog niet geladen is
            ...
            element.innerHTML = `
                ...
                <table border="1" cellpadding="8" style="width:100%; border-collapse: collapse; margin-top:20px;">
                    <tr style="background-color: #f2f2f2;">
                        <th style="text-align:left;">Vraag</th>
